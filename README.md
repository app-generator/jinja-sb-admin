...
- [Jinja Template - Sb Admin](https://jinja-template-sb-admin.appseed.us/) - LIVE Demo
...
```bash
$ # Clone the sources
$ git clone https://github.com/app-generator/jinja-template-sb-admin.git
$ cd jinja-template-sb-admin
$
...
$
$ # Run the Jinja Template - Sb Admin
